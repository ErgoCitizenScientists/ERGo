 ...
 * made for ERG expansion board V0.1 
 * made to interface with Grass Foundation board V0.93
 */
...
const int RED_PIN=9, GREEN_PIN=10, BLUE_PIN=11, IR_PIN=7, UV_PIN=8;
...
//10 pin connector
//across ground - A1D  - D6
//below ground - A0D - D4
//across A0D - IO5 - D5

const int IO5 = 4;// analog input 0 on Grass board
const int IGNORE2 = 5;// digital event 5 
const int IGNORE1 = 6;// analog input 1 on Grass board

const int CLK =12;
const int DATA_OUT =13;
...
void setup() {
  ...
  pinMode(BTN1, INPUT);
  pinMode(BTN2, INPUT);
  pinMode(IGNORE2, INPUT);
  pinMode(IO5, OUTPUT);
  pinMode(IGNORE1, INPUT);
